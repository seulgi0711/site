...
type FileFieldsEnum =
  ...
  | 'childMdx.frontmatter.coverImage.sourceInstanceName'
  | 'childMdx.frontmatter.coverImage.absolutePath'
  | 'childMdx.frontmatter.coverImage.relativePath'
  | 'childMdx.frontmatter.coverImage.extension'
  | 'childMdx.frontmatter.coverImage.size'
  | 'childMdx.frontmatter.coverImage.prettySize'
  | 'childMdx.frontmatter.coverImage.modifiedTime'
  | 'childMdx.frontmatter.coverImage.accessTime'
  | 'childMdx.frontmatter.coverImage.changeTime'
  | 'childMdx.frontmatter.coverImage.birthTime'
  | 'childMdx.frontmatter.coverImage.root'
  | 'childMdx.frontmatter.coverImage.dir'
  | 'childMdx.frontmatter.coverImage.base'
  | 'childMdx.frontmatter.coverImage.ext'
  | 'childMdx.frontmatter.coverImage.name'
  | 'childMdx.frontmatter.coverImage.relativeDirectory'
  | 'childMdx.frontmatter.coverImage.dev'
  | 'childMdx.frontmatter.coverImage.mode'
  | 'childMdx.frontmatter.coverImage.nlink'
  | 'childMdx.frontmatter.coverImage.uid'
  | 'childMdx.frontmatter.coverImage.gid'
  | 'childMdx.frontmatter.coverImage.rdev'
  | 'childMdx.frontmatter.coverImage.ino'
  | 'childMdx.frontmatter.coverImage.atimeMs'
  | 'childMdx.frontmatter.coverImage.mtimeMs'
  | 'childMdx.frontmatter.coverImage.ctimeMs'
  | 'childMdx.frontmatter.coverImage.atime'
  | 'childMdx.frontmatter.coverImage.mtime'
  | 'childMdx.frontmatter.coverImage.ctime'
  | 'childMdx.frontmatter.coverImage.birthtime'
  | 'childMdx.frontmatter.coverImage.birthtimeMs'
  | 'childMdx.frontmatter.coverImage.blksize'
  | 'childMdx.frontmatter.coverImage.blocks'
  | 'childMdx.frontmatter.coverImage.publicURL'
  | 'childMdx.frontmatter.coverImage.id'
  | 'childMdx.frontmatter.coverImage.children'
  | 'childMdx.slug'
  | 'childMdx.body'
  | 'childMdx.excerpt'
  | 'childMdx.headings'
...
type MdxFieldsEnum =
  ...
  | 'frontmatter.coverImage.childMdx.rawBody'
  | 'frontmatter.coverImage.childMdx.fileAbsolutePath'
  | 'frontmatter.coverImage.childMdx.slug'
  | 'frontmatter.coverImage.childMdx.body'
  | 'frontmatter.coverImage.childMdx.excerpt'
  | 'frontmatter.coverImage.childMdx.headings'
  | 'frontmatter.coverImage.childMdx.html'
  | 'frontmatter.coverImage.childMdx.mdxAST'
  | 'frontmatter.coverImage.childMdx.tableOfContents'
  | 'frontmatter.coverImage.childMdx.timeToRead'
  | 'frontmatter.coverImage.childMdx.id'
  | 'frontmatter.coverImage.childMdx.children'
  | 'slug'
  | 'body'
  | 'excerpt'
  | 'headings'
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.copyrights'
  | 'siteMetadata.author'
  | 'siteMetadata.logo.src'
  | 'siteMetadata.logo.alt'
  | 'siteMetadata.logoText'
  | 'siteMetadata.defaultTheme'
...
type SiteSiteMetadata = {
  ...
  readonly author: Maybe<Scalars['String']>;
  readonly logo: Maybe<SiteSiteMetadataLogo>;
  readonly logoText: Maybe<Scalars['String']>;
  readonly defaultTheme: Maybe<Scalars['String']>;
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly author: Maybe<StringQueryOperatorInput>;
  readonly logo: Maybe<SiteSiteMetadataLogoFilterInput>;
  readonly logoText: Maybe<StringQueryOperatorInput>;
  readonly defaultTheme: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataLogoFilterInput = {
  readonly src: Maybe<StringQueryOperatorInput>;
...
type PostsQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id' | 'excerpt'>
        & { readonly frontmatter: (
          Pick<Frontmatter, 'title' | 'date' | 'path' | 'author' | 'excerpt' | 'tags'>
          & { readonly coverImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment>, readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }
        ) }
      ) }> } };

type usersseongseulgigitsitesrctemplatesPostTemplateindexTsx1702667944QueryVariables = Exact<{
  path: Maybe<Scalars['String']>;
}>;


type usersseongseulgigitsitesrctemplatesPostTemplateindexTsx1702667944Query = { readonly mdx: Maybe<(
...
type usersseongseulgigitsitesrctemplatesTagsindexTsx884656603QueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  tag: Scalars['String'];
}>;
...
type usersseongseulgigitsitesrctemplatesTagsindexTsx884656603Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id' | 'excerpt'>
        & { readonly frontmatter: (
          Pick<Frontmatter, 'title' | 'date' | 'path' | 'author' | 'excerpt' | 'tags'>
          & { readonly coverImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }
...
type AboutQueryQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }> };
...
type SiteTitleQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'logoText' | 'defaultTheme' | 'copyrights'>
      & { readonly logo: Maybe<Pick<SiteSiteMetadataLogo, 'src' | 'alt'>> }
    )> }> };

type ProfileImageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type ProfileImageQueryQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }> };

type SiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


type SiteMetadataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'copyrights' | 'author' | 'logoText' | 'defaultTheme' | 'postsPerPage' | 'siteUrl'>
      & { readonly logo: Maybe<Pick<SiteSiteMetadataLogo, 'src' | 'alt'>> }
    )> }> };
