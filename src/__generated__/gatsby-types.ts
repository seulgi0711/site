...
type userskakaoEntgitsitesrctemplatesPostTemplateindexTsx1702667944QueryVariables = Exact<{
  path: Maybe<Scalars['String']>;
}>;


type userskakaoEntgitsitesrctemplatesPostTemplateindexTsx1702667944Query = { readonly mdx: Maybe<(
...
type userskakaoEntgitsitesrctemplatesTagsindexTsx884656603QueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  tag: Scalars['String'];
}>;
...
type userskakaoEntgitsitesrctemplatesTagsindexTsx884656603Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id' | 'excerpt'>
        & { readonly frontmatter: (
          Pick<Frontmatter, 'title' | 'date' | 'path' | 'author' | 'excerpt' | 'tags'>
          & { readonly coverImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }
